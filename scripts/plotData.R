...
plot(data1[,1], data1[,2], type = "b", frame = FALSE, pch = 19, col = "red", xlab = "Iteraciones", ylab = "ms")
...
legend("topleft", legend=c("Scala", "Parallel","Java","Java Funcional"), col=c("green", "blue","orange","red"), lty = 1:2, cex=0.8)